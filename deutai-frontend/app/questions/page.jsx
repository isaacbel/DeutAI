...
const QUESTION_TYPES = [
  {
    id: 'vocabulaire',
    title: 'Vocabulaire',
    description: 'Testez votre connaissance des mots et de leurs définitions.',
    icon: BookOpen,
    color: '#C9A227',
  ...
  },
  {
    id: 'grammaire',
    title: 'Grammaire',
    description: 'Exercez-vous sur les règles de grammaire et la structure des phrases.',
    icon: FileText,
    color: '#4DA8DA',
  ...
  },
  {
    id: 'conjugaison',
    title: 'Conjugaison',
    description: 'Pratiquez les verbes forts, faibles et irréguliers aux différents temps.',
    icon: Zap,
    color: '#E06C6C',
  ...
  },
  {
    id: 'comprehension',
    title: 'Compréhension',
    description: 'Testez votre compréhension à travers des énoncés et des textes.',
    icon: MessageCircle,
    color: '#7B61FF',
      ...
      <div className="max-w-5xl mx-auto px-6 py-12 lg:py-16 relative z-10">
        ...
        >
          ...
          <p className="text-lg" style={{ color: '#8890aa', maxWidth: '600px' }}>
            Sélectionnez un domaine pour démarrer un questionnaire personnalisé.
            L'IA s'adaptera à votre niveau actuel.
          </p>
        </motion.div>
          ...
          {QUESTION_TYPES.map((type, idx) => {
            ...
            return (
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="group relative flex flex-col text-left p-6 lg:p-8 rounded-3xl overflow-hidden"
                style={{
              ...
              >
                ...
                <div className="flex items-center gap-2 mt-auto">
                  ...
                  <span className="font-mono text-xs tracking-wider uppercase font-semibold" style={{ color: type.color }}>
                    {type.questionsCount} Questions dispo.
                  </span>
                </div>
              </motion.button>
            );
